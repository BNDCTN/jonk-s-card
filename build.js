...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Vue2Filters = __webpack_require__(52)
...
/***/ (function(module, exports) {
	...
	module.exports = {
		...
		components: {
			first: {
				template: '<img src="components/gallery/0.jpg" alt="1"></img>'
			},
			second: {
				template: '<img src="components/gallery/1.jpg" alt="2"></img>'
			},
			third: {
				template: '<img src="components/gallery/2.jpg" alt="3"></img>'
			}
		},
		methods: {
			...
			carousel: function carousel() {
				if (this.i == 2) this.reset();else {
					this.i++;
					this.currentSlide = this.pics[this.i];
				}
			},
...
/***/ (function(module, exports) {
	...
	module.exports = "\r\n<h1>{{ currentSlide }}</h1>\r\n\r\n<div class=\"slideContainer\" v-on:load=\"changeSlide\">\r\n\t<!--component class=\"slideShow\" v-bind:is='currentSlide' \r\n\ttransition=\"switch\" v-on:load=\"changeSlide\"></component-->\r\n\r\n\t\t<first class=\"slideShow\" v-if=\"currentSlide == 'first'\" transition=\"switch\"\r\n\t\t v-on:load=\"changeSlide\"></first>\r\n\r\n\t\t<second class=\"slideShow\" v-if=\"currentSlide=='second'\" transition=\"switch\"\r\n\t\t v-on:load=\"changeSlide\"></second>\r\n\r\n\t\t<third class=\"slideShow\" v-if=\"currentSlide == 'third'\" transition=\"switch\"\r\n\t\t v-on:load=\"resetSlide\"></third>\r\n\r\n</div>\r\n\r\n";
	...
	module.exports = {
		...
		methods: {
			onClick: function onClick(e) {
				if (e.name == 'Gallery') document.getElementById('gallery').scrollIntoView(top);else if (e.name == 'Contacts') window.scrollDown(0, 50);
			}
		}
	};
...
/***/ (function(module, exports) {
	...
	module.exports = "\r\n<nav id=\"navbar\">\r\n\r\n\t<li v-for=\"item in items\"  v-on:click=\"onClick(item)\"> {{item.name}} </li>\t\r\n\r\n</nav>\r\n \r\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\gallery.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-8b1d966c/gallery.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./gallery.vue", function() {
				var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./gallery.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	module.exports = {
		...
		computed: {
			...
			leftpages: function leftpages() {
				if (this.currentPage - 1 >= 1) return 1;else return this.currentPage - 1;
			},
			rightpages: function rightpages() {
				if (this.pages > 1) return this.pages - this.currentPage;else return 1;
			},
			buttonsLock: function buttonsLock(page) {
				if (page === 1 || page === this.currentPage - 2 || page === this.currentPage - 1 || page === this.currentPage || page === this.currentPage + 1 || page === this.currentPage + 2 || page === this.pages) return true;else return false;
			},
		...
		methods: {
			...
			chooseFile: function chooseFile(file) {
				if (file.type == "Folder") this.chooseFol(file);else this.choosePic(file);
			},

			nextPic: function nextPic(thisPic) {
			...
			prevPic: function prevPic(thisPic) {
				if (thisPic.id > 0) {
					this.showPicture = true;
					this.chosenPicId = this.files[thisPic.id - 1];
				}
			...
			chooseCategory: function chooseCategory(input) {
				if (input == 'Всі') this.input = '';else this.input = input;
			},

			chooseAndHide: function chooseAndHide(input, show) {
			...
			compareFiles: function compareFiles(a, b) {
				if (a.type > b.type) return -1;
				if (a.type < b.type) return 1;
				return 0;
			},
			curtain: function curtain(file) {
				var src = "";
			...
			freezeLoad: function freezeLoad(files) {
				var _this = this;
				...
				setTimeout(function () {
					if (files != null) {
						_this.files = files;
						_this.files.shift();
						_this.files.sort(_this.compareFiles);
			...
			loadContent: function loadContent(folder) {
				var i = 0;
				var uRL = folder;
				var files = [];
				$.ajax({ url: uRL, success: function success(data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\about.vue: named exports in *.vue files are ignored.")}
...
/***/ (function(module, exports) {
	...
	module.exports = {
		data: function data() {
			return {
				designer: {
					name: 'Serhii Benedyshyn',
					age: 24,
					email: ['srhiibenedyshyn@gmail.com', 'benedyshyn@ukr.net'],
					phoneNo: ['+380 093 8787040', '+380 068 0552836'],
					photoPath: './components/about/1.jpg'
				}
			};
		},
		methods: {
...
/***/ (function(module, exports) {
	...
	module.exports = "\n<div id=\"layer\">\n\t<center>\n\t\t<section class=\"TopBar\" v-on:click=\"inFocus\">\n\t\t\t<div class=\"container\">\n\t\t\t\t<h3>About</h3>\n\t\t\t</div>\n\t\t</section>\n\t</center>\n\n\t\t<section class=\"info\">\n\t\t\t<div class=\"name\">\n\t\t\t\t{{designer.name}}\n\t\t\t</div>\n\t\t\t<div class=\"photo\">\n\t\t\t\t<!--section class=\"tittle\">Photo</section-->\n\t\t\t\t\t<section class=\"contactscontent\">\n\t\t\t\t\t\t<center>\n\t\t\t\t\t\t\t<img class=\"facebook\" v-bind:src=designer.photoPath alt={{designer.photoPath}}></img>\n\t\t\t\t\t\t</center>\n\t\t\t\t\t</section>\n\t\t\t</div>\n\t\t\n\n\t\t\t<div class=\"contacts\">\n\t\t\t\t<section class=\"tittle\">Contacts</section>\n\t\t\t\t<section class=\"contactscontent\">\n\t\t\t\t<section class=\"element\">\n\t\t\t\t<div class=\"contactnames\">phone: </div>\n\t\t\t\t<div class=\"contactarray\"> {{designer.phoneNo.join(', ')}} </div>\n\t\t\t\t</section>\n\t\t\t\t<br>\n\t\t\t\t<div class=\"marger\"></div>\n\t\t\t\t<section class=\"element\">\t\n\t\t\t\t<div class=\"contactnames\">email: </div>\n\t\t\t\t<div class=\"contactarray\"> {{designer.email.join(', ')}} </div>\n\t\t\t\t</section>\n\t\t\t\t</section>\n\t\t\t</div>\n\n\t\t\t<div class=\"contacts\">\n\t\t\t\t<section class=\"tittle\">Links</section>\n\t\t\t\t<section class=\"linkscontent\">\n\t\t\t\t\t<a href='https://www.facebook.com/' target=\"_blank\">\n\t\t\t\t\t<i class=\"ion-social-facebook-outline\"></i></a>\n\t\t\t\t\t<a href='https://www.instagram.com/' target=\"_blank\">\n\t\t\t\t\t<i class=\"ion-social-instagram-outline\"></i></a>\t\t\n\t\t\t\t</section>\n\t\t\t</div>\n\n\t\t</section>\n\n\n\n\n</div>\n\t\t<section class=\"BottomBar\">\n\t\t\t<h5>Demo version</h5>\n\t\t</section>\n";
